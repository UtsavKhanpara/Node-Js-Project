...
module.exports.insertblog = async (req, res) => {
    try {
        ...
        req.flash("success", "Blog Add end View Successfully ✅"); 
...
//only view Blog
module.exports.websiteViewBlog = async (req, res) => {
    try {
        // let admin = req.cookies.admin;
        const data = await blogmodel.find();
        res.render("blog/websiteviewblog", {data} );
    } catch (err) {
        console.log(err);
    }
};
